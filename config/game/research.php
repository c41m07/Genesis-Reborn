...
$categoryImages = [
        'Propulsion' => 'assets/svg/illustrations/research/propulsion.svg',
        'Ingénierie' => 'assets/svg/illustrations/research/engineering.svg',
        'Défense' => 'assets/svg/illustrations/research/defense.svg',
        'Armement' => 'assets/svg/illustrations/research/armament.svg',
        'Capteurs' => 'assets/svg/illustrations/research/sensors.svg',
        'Construction' => 'assets/svg/illustrations/research/construction.svg',
        'Commandement' => 'assets/svg/illustrations/research/command.svg',
];
$defaultImage = 'assets/svg/illustrations/placeholders/research-default.svg';
...
$cfg = [
        ...
        'life_support' => [
            ...
            'base_cost' => ['metal' => 90, 'crystal' => 110, 'hydrogen' => 40],
            'base_time' => 55,
            'growth_cost' => 1.6,
            'growth_time' => 1.55,
            'max_level' => 10,
        ...
        'miniaturisation' => [
            ...
            'base_cost' => ['metal' => 140, 'crystal' => 150, 'hydrogen' => 60],
            'base_time' => 60,
            'growth_cost' => 1.65,
            'growth_time' => 1.6,
            'max_level' => 10,
            'requires' => ['life_support' => 2],
            'requires_lab' => 1,
        ],
        'armor_basic' => [
            ...
            'base_cost' => ['metal' => 160, 'crystal' => 120, 'hydrogen' => 40],
            'base_time' => 65,
            'growth_cost' => 1.65,
            'growth_time' => 1.65,
            'max_level' => 10,
            'requires' => ['miniaturisation' => 2],
            'requires_lab' => 1,
        ],
        'weapon_light' => [
            'label' => 'Armes légères',
            ...
            'base_cost' => ['metal' => 150, 'crystal' => 170, 'hydrogen' => 60],
            'base_time' => 70,
            'growth_cost' => 1.65,
            'growth_time' => 1.6,
            'max_level' => 10,
        ...
        'radar_basic' => [
            ...
            'base_cost' => ['metal' => 110, 'crystal' => 160, 'hydrogen' => 60],
            'base_time' => 65,
            'growth_cost' => 1.6,
            'growth_time' => 1.55,
            'max_level' => 10,
            'requires' => ['miniaturisation' => 1],
            'requires_lab' => 1,
        ],
        'armor_enhanced' => [
            ...
            'base_cost' => ['metal' => 260, 'crystal' => 210, 'hydrogen' => 90],
            'base_time' => 90,
            'growth_cost' => 1.7,
            'growth_time' => 1.65,
            'max_level' => 10,
            'requires' => ['armor_basic' => 5],
            'requires_lab' => 2,
        ],
        'shield_energy' => [
            ...
            'base_cost' => ['metal' => 240, 'crystal' => 260, 'hydrogen' => 140],
            'base_time' => 95,
            'growth_cost' => 1.72,
            'growth_time' => 1.65,
            'max_level' => 10,
            'requires' => ['armor_enhanced' => 3, 'weapon_light' => 4],
            'requires_lab' => 2,
        ],
        'weapon_medium' => [
            ...
            'base_cost' => ['metal' => 260, 'crystal' => 280, 'hydrogen' => 160],
            'base_time' => 100,
            'growth_cost' => 1.7,
            'growth_time' => 1.65,
            'max_level' => 10,
            'requires' => ['weapon_light' => 6],
            'requires_lab' => 2,
        ],
        'logistics' => [
            ...
            'base_cost' => ['metal' => 220, 'crystal' => 200, 'hydrogen' => 140],
            'base_time' => 90,
            'growth_cost' => 1.68,
            'growth_time' => 1.62,
            'max_level' => 10,
            'requires' => ['propulsion_basic' => 4, 'life_support' => 4],
            'requires_lab' => 2,
        ],
        'engineering_heavy' => [
            ...
            'base_cost' => ['metal' => 320, 'crystal' => 260, 'hydrogen' => 160],
            'base_time' => 110,
            'growth_cost' => 1.72,
            'growth_time' => 1.68,
            'max_level' => 10,
        ...
        'reactor_advanced' => [
            ...
            'growth_time' => 1.7,
            'max_level' => 10,
            'requires' => ['propulsion_basic' => 5, 'engineering_heavy' => 2],
            'requires_lab' => 3,
        ],
        'weapon_heavy' => [
            'label' => 'Armes lourdes',
            ...
            'base_cost' => ['metal' => 420, 'crystal' => 380, 'hydrogen' => 260],
            'base_time' => 140,
            'growth_cost' => 1.75,
            'growth_time' => 1.72,
            'max_level' => 10,
            'requires' => ['weapon_medium' => 5, 'reactor_advanced' => 2],
            'requires_lab' => 3,
        ],
        'tactical_coordination' => [
            ...
            'base_cost' => ['metal' => 360, 'crystal' => 420, 'hydrogen' => 200],
            'base_time' => 135,
            'growth_cost' => 1.7,
            'growth_time' => 1.68,
            'max_level' => 10,
            'requires' => ['radar_basic' => 5, 'logistics' => 5],
            'requires_lab' => 3,
        ],
        'superstructures' => [
            ...
            'base_cost' => ['metal' => 520, 'crystal' => 460, 'hydrogen' => 260],
            'base_time' => 150,
            'growth_cost' => 1.78,
            'growth_time' => 1.72,
            'max_level' => 10,
            'requires' => ['engineering_heavy' => 5],
            'requires_lab' => 4,
        ],
        'reactor_antimatter' => [
            ...
            'base_cost' => ['metal' => 620, 'crystal' => 540, 'hydrogen' => 340],
            'base_time' => 170,
            'growth_cost' => 1.8,
            'growth_time' => 1.75,
            'max_level' => 10,
            'requires' => ['reactor_advanced' => 6, 'superstructures' => 3],
            'requires_lab' => 4,
        ],
        'weapon_capital' => [
            ...
            'base_cost' => ['metal' => 680, 'crystal' => 620, 'hydrogen' => 360],
            'base_time' => 180,
            'growth_cost' => 1.82,
            'growth_time' => 1.76,
            'max_level' => 10,
            'requires' => ['weapon_heavy' => 6, 'superstructures' => 4],
            'requires_lab' => 4,
        ],
        'defense_multilayer' => [
            ...
            'base_cost' => ['metal' => 640, 'crystal' => 560, 'hydrogen' => 340],
            'base_time' => 175,
            'growth_cost' => 1.78,
            'growth_time' => 1.74,
            'max_level' => 10,
            'requires' => ['armor_enhanced' => 6, 'shield_energy' => 5],
            'requires_lab' => 4,
        ],
        'stellar_shipyards' => [
            ...
            'base_cost' => ['metal' => 720, 'crystal' => 660, 'hydrogen' => 420],
            'base_time' => 185,
            'growth_cost' => 1.8,
            'growth_time' => 1.76,
            'max_level' => 10,
            'requires' => ['superstructures' => 5, 'engineering_heavy' => 7],
            'requires_lab' => 4,
        ],
        'autonomous_hangars' => [
            ...
            'base_cost' => ['metal' => 760, 'crystal' => 680, 'hydrogen' => 440],
            'base_time' => 190,
            'growth_cost' => 1.8,
            'growth_time' => 1.78,
            'max_level' => 10,
            'requires' => ['stellar_shipyards' => 2, 'tactical_coordination' => 4],
            'requires_lab' => 4,
        ],
        'super_weapon' => [
            ...
            'base_cost' => ['metal' => 880, 'crystal' => 760, 'hydrogen' => 520],
            'base_time' => 210,
            'growth_cost' => 1.85,
            'growth_time' => 1.8,
            'max_level' => 10,
            'requires' => ['weapon_capital' => 4, 'reactor_antimatter' => 4],
            'requires_lab' => 5,
        ],
        'fleet_networks' => [
            ...
            'base_cost' => ['metal' => 820, 'crystal' => 780, 'hydrogen' => 480],
            'base_time' => 205,
            'growth_cost' => 1.82,
            'growth_time' => 1.78,
            'max_level' => 10,
            'requires' => ['tactical_coordination' => 6, 'autonomous_hangars' => 3],
            'requires_lab' => 5,
        ],
    ];
foreach ($cfg as $key => &$entry) {
    ...
    if (empty($entry['image'])) {
        $entry['image'] = $categoryImages[$category] ?? $defaultImage;
    }
}
unset($entry);
