-- Seed catalog tables (buildings, technologies, ships) from balance YAML snapshot
-- This migration mirrors the data distributed in config/balance/*.yml so a fresh
-- database receives a consistent catalog without requiring manual imports.
...
INSERT INTO technologies (
    ...
    base_cost_metal, base_cost_crystal, base_cost_hydrogen, base_energy_cost,
    cost_multiplier, base_duration_seconds, unlock_requirements,
...
INSERT INTO buildings (
    ...
    base_cost_metal, base_cost_crystal, base_cost_hydrogen, base_energy_cost,
    cost_multiplier,
    base_production_metal, base_production_crystal, base_production_hydrogen,
    base_storage, base_energy_production, base_energy_consumption,
    unlock_requirements,
    created_at, updated_at
) VALUES
    ...
    ('worker_factory', 'Complexe d’ouvriers', 'Automatise la logistique locale grâce à des essaims de drones.', 'storage', 420, 160, 0, 0, 1.600, 0, 0, 0, 0, 0, 18, '{"buildings":{"metal_mine":4,"crystal_mine":3}}', @now, @now),
    ('robot_factory', 'Chantier robotique', 'Assemblage lourd de robots spécialisés optimisant chaque construction.', 'storage', 2400, 1200, 300, 0, 1.750, 0, 0, 0, 0, 0, 36, '{"buildings":{"worker_factory":6,"research_lab":2},"technologies":{"engineering_heavy":3}}', @now, @now),
...
-- Ships
INSERT INTO ships (
    `key`, name, description, class,
    base_cost_metal, base_cost_crystal, base_cost_hydrogen, base_energy_cost,
    build_time_seconds, base_speed, base_cargo, fuel_per_hour,
    attack, defense, shield, unlock_requirements,
    created_at, updated_at
) VALUES
    ('fighter', 'Ailes Lyrae', 'Véhicule agile conçu pour intercepter rapidement les menaces proches et saturer la défense adverse.', 'fighter', 220, 90, 45, 0, 60, 22.50, 60, 9.000000, 6, 3, 3, '{"technologies":{"propulsion_basic":1,"life_support":2,"miniaturisation":2,"weapon_light":2,"radar_basic":1}}', @now, @now),
    ('bomber', 'Maraudeur Obsidien', 'Transporte un arsenal de torpilles magnétiques capables de briser le blindage des cibles capitales.', 'fighter', 420, 260, 120, 0, 140, 15.00, 120, 24.000000, 15, 6, 6, '{"technologies":{"life_support":2,"miniaturisation":2,"armor_basic":2,"weapon_light":6,"weapon_medium":1}}', @now, @now),
    ('interceptor', 'Éclair Stentor', 'Priorité à la vitesse et à la précision pour contrer les chasseurs ennemis et les éclaireurs.', 'fighter', 280, 160, 90, 0, 90, 30.00, 80, 18.000000, 7, 4, 4, '{"technologies":{"propulsion_basic":2,"life_support":3,"miniaturisation":3,"weapon_light":3,"radar_basic":3}}', @now, @now),
    ('heavy_fighter', 'Griffon Halcyon', 'Combine l’armement d’un bombardier à la mobilité d’un intercepteur pour dominer la ligne de front.', 'fighter', 520, 360, 160, 0, 180, 20.00, 200, 32.000000, 18, 10, 10, '{"technologies":{"propulsion_basic":3,"life_support":3,"miniaturisation":4,"weapon_light":4,"radar_basic":3,"armor_basic":3}}', @now, @now),
    ('corvette', 'Corvette Vigilum', 'Assure la reconnaissance, la couverture anti-chasseur et la projection rapide de puissance légère.', 'frigate', 950, 520, 220, 0, 300, 17.50, 440, 44.000000, 28, 22, 22, '{"technologies":{"propulsion_basic":4,"life_support":4,"logistics":1,"armor_basic":5,"armor_enhanced":1,"weapon_light":6,"weapon_medium":3,"radar_basic":3}}', @now, @now),
    ('gunship', 'Havoc Aster', 'Embarque des canons à plasma lourds pour perforer les coques des navires moyens.', 'frigate', 1250, 720, 260, 0, 420, 15.00, 560, 52.000000, 40, 28, 28, '{"technologies":{"armor_basic":5,"armor_enhanced":1,"weapon_light":6,"weapon_medium":2,"radar_basic":3}}', @now, @now),
    ('frigate', 'Frégate Solstice', 'Grille de missiles défensifs et batteries traçantes pour protéger les unités capitales.', 'frigate', 2200, 1350, 480, 0, 600, 12.50, 960, 96.000000, 55, 48, 48, '{"technologies":{"armor_basic":5,"armor_enhanced":3,"weapon_light":4,"shield_energy":1,"weapon_medium":4,"propulsion_basic":4,"life_support":4,"logistics":2,"tactical_coordination":1}}', @now, @now),
    ('destroyer', 'Destroyer Fulguris', 'Longue coque bardée de canons rails optimisés pour démanteler les escorteurs ennemis.', 'capital', 3600, 2400, 800, 0, 900, 11.25, 1200, 160.000000, 80, 60, 60, '{"technologies":{"engineering_heavy":2,"propulsion_basic":5,"reactor_advanced":2,"weapon_light":6,"weapon_medium":5,"weapon_heavy":1,"tactical_coordination":3}}', @now, @now),
    ('light_cruiser', 'Croiseur Lumen', 'Équilibre propulsion, blindage et puissance de feu pour mener des flottes rapides.', 'capital', 5200, 3600, 1200, 0, 1200, 10.00, 1900, 240.000000, 110, 95, 95, '{"technologies":{"engineering_heavy":3,"armor_basic":6,"armor_enhanced":3,"weapon_light":4,"shield_energy":3,"reactor_advanced":3,"weapon_medium":5,"weapon_heavy":2,"tactical_coordination":3}}', @now, @now),
    ('heavy_cruiser', 'Croiseur Axiom', 'Blindage renforcé, artillerie lourde et systèmes de projection pour les batailles d’attrition.', 'capital', 8800, 6200, 1800, 0, 1800, 8.75, 2800, 360.000000, 150, 140, 140, '{"technologies":{"engineering_heavy":5,"superstructures":1,"reactor_advanced":4,"weapon_medium":5,"weapon_heavy":3,"armor_basic":6,"armor_enhanced":6,"weapon_light":5,"shield_energy":5,"defense_multilayer":2,"tactical_coordination":4}}', @now, @now),
    ('battleship', 'Cuirassé Helior', 'Boucliers étagés et batteries orbitales massives pour absorber et infliger d’énormes dégâts.', 'capital', 15000, 9800, 2600, 0, 2700, 7.50, 5200, 520.000000, 220, 260, 260, '{"technologies":{"engineering_heavy":5,"superstructures":4,"reactor_advanced":6,"reactor_antimatter":1,"weapon_medium":6,"weapon_heavy":6,"weapon_capital":1,"armor_basic":6,"armor_enhanced":6,"weapon_light":5,"shield_energy":5,"defense_multilayer":3}}', @now, @now),
    ('battlecruiser', 'Arbiter Solaris', 'Compromis entre vitesse et artillerie lourde pour manœuvrer autour des cuirassés ennemis.', 'capital', 18800, 12600, 3200, 0, 3300, 8.75, 4200, 640.000000, 240, 210, 210, '{"technologies":{"engineering_heavy":5,"superstructures":2,"reactor_advanced":5,"weapon_medium":5,"weapon_heavy":4,"tactical_coordination":5}}', @now, @now),
    ('dreadnought', 'Dreadnought Orichal', 'Pièce maîtresse d’une armada, concentrant le feu de multiples batteries super-lourdes.', 'capital', 26000, 18000, 4200, 0, 4200, 6.25, 6400, 840.000000, 320, 320, 320, '{"technologies":{"engineering_heavy":7,"superstructures":4,"reactor_advanced":6,"reactor_antimatter":2,"weapon_heavy":6,"weapon_capital":2,"armor_enhanced":6,"shield_energy":5,"defense_multilayer":4,"tactical_coordination":6,"stellar_shipyards":2}}', @now, @now),
    ('carrier', 'Porte-chasseurs Aegira', 'Hangars magnétiques pouvant lancer simultanément des vagues complètes d’escadrilles.', 'capital', 22000, 21000, 5200, 0, 4500, 6.25, 6000, 1040.000000, 180, 300, 300, '{"technologies":{"engineering_heavy":7,"superstructures":5,"stellar_shipyards":2,"tactical_coordination":4,"autonomous_hangars":3,"reactor_advanced":5,"weapon_medium":5,"shield_energy":5,"armor_enhanced":6,"fleet_networks":2}}', @now, @now),
    ('colony_ship', 'Arche Horizon', 'Déploie habitats, générateurs et équipes pionnières pour établir une nouvelle colonie autonome.', 'utility', 9600, 7200, 5400, 0, 3600, 10.00, 2500, 420.000000, 12, 220, 220, '{"technologies":{"logistics":4,"life_support":5,"engineering_heavy":2,"propulsion_basic":5,"shield_energy":2}}', @now, @now),
    ('heavy_transport', 'Transporteur Atlas', 'Plate-forme d’atterrissage blindée pour déployer troupes, véhicules ou modules orbitaux.', 'utility', 12800, 9000, 6400, 0, 3000, 7.50, 13500, 1280.000000, 70, 150, 150, '{"technologies":{"propulsion_basic":4,"life_support":4,"logistics":3,"engineering_heavy":2,"armor_basic":3,"weapon_light":3,"tactical_coordination":1}}', @now, @now),
    ('command_ship', 'Vaisseau de commandement Novarch', 'Coordinateur de flotte doté de suites tactiques avancées et de systèmes de communications quantiques.', 'utility', 24000, 20000, 7000, 0, 4800, 6.25, 6800, 1400.000000, 160, 340, 340, '{"technologies":{"tactical_coordination":5,"fleet_networks":2,"autonomous_hangars":2,"shield_energy":4,"armor_enhanced":4,"weapon_medium":4}}', @now, @now),
    ('super_battleship', 'Super-cuirassé Empyrium', 'Vaisseau emblématique, quasiment indestructible, arborant une armure multi-couches et un armement d’anéantissement.', 'capital', 54000, 42000, 12000, 0, 9000, 5.00, 0, 2400.000000, 420, 520, 520, '{"technologies":{"engineering_heavy":7,"superstructures":5,"stellar_shipyards":3,"reactor_advanced":6,"reactor_antimatter":3,"weapon_heavy":6,"weapon_capital":3,"armor_enhanced":6,"shield_energy":5,"defense_multilayer":5}}', @now, @now),
    ('siege_breaker', 'Cuirassé de siège Ragnarok', 'Optimisé pour raser les fortifications planétaires grâce à des canons gravitoniques massifs.', 'capital', 62000, 46000, 15000, 0, 9600, 5.00, 0, 3000.000000, 480, 480, 480, '{"technologies":{"engineering_heavy":7,"superstructures":5,"stellar_shipyards":3,"weapon_capital":3,"super_weapon":1,"reactor_antimatter":3,"defense_multilayer":4,"shield_energy":5}}', @now, @now),
    ('super_dreadnought', 'Super-dreadnought Nemesis', 'Capable de déployer un canon stellaire, ce navire dicte l’issue de n’importe quelle bataille.', 'capital', 72000, 56000, 18000, 0, 10800, 3.75, 0, 3600.000000, 560, 580, 580, '{"technologies":{"engineering_heavy":7,"superstructures":5,"stellar_shipyards":3,"reactor_advanced":6,"reactor_antimatter":4,"weapon_heavy":6,"weapon_capital":4,"super_weapon":1,"armor_enhanced":6,"shield_energy":5,"defense_multilayer":5,"fleet_networks":3}}', @now, @now),
    ('battle_station', 'Citadelle Astra', 'Forteresse orbitale dotée d’un anneau de super-lasers et de plates-formes autonomes.', 'capital', 95000, 82000, 25000, 0, 14400, 0.00, 15200, 5000.000000, 680, 760, 760, '{"technologies":{"engineering_heavy":7,"superstructures":6,"stellar_shipyards":4,"armor_enhanced":6,"shield_energy":5,"defense_multilayer":5,"weapon_capital":3,"super_weapon":1,"fleet_networks":3}}', @now, @now)
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    description = VALUES(description),
    class = VALUES(class),
    ...
    fuel_per_hour = VALUES(fuel_per_hour),
