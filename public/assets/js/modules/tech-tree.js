        ...
        .map((requirement) => {
          ...
          if (key !== '' && planetId !== '') {
            if (requirement.type === 'building') {
              requirementUrl = `${normalizedBase}/colony?planet=${encodeURIComponent(planetId)}#building-${encodeURIComponent(key)}`;
            } else if (requirement.type === 'research') {
              requirementUrl = `${normalizedBase}/research?planet=${encodeURIComponent(planetId)}#research-${encodeURIComponent(key)}`;
            }
          }
