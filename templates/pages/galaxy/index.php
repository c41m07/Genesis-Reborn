...
?>
    <section class="page-header">
        <div>
            <h1>Carte galaxie</h1>
            <p class="page-header__subtitle">Analyse des positions du
                système <?= htmlspecialchars($summary['galaxy']) ?>:<?= htmlspecialchars($summary['system']) ?>.</p>
        </div>
        <form class="galaxy-controls" method="get" action="<?= htmlspecialchars($baseUrl) ?>/galaxy">
            <div class="galaxy-controls__group">
                ...
                <input id="galaxy-input" type="number" name="galaxy" min="1"
                       value="<?= htmlspecialchars((string)($filters['galaxy'] ?? 1)) ?>">
            </div>
            <div class="galaxy-controls__group">
                <label for="system-input">Système</label>
                <input id="system-input" type="number" name="system" min="1"
            ...
            <div class="galaxy-controls__group galaxy-controls__group--search">
                ...
                <input id="galaxy-search" type="search" name="q" placeholder="Nom, joueur ou coordonnées"
