...
INSERT INTO buildings (
    ...
    base_energy_cost,
    cost_multiplier,
    base_production_metal,
    base_production_crystal,
    base_production_hydrogen,
    base_storage,
    ...
    (
        'workers_hub',
        'Centre d’ouvriers',
        'Optimise la main-d’œuvre et réduit les délais de construction.',
        'support',
        450,
        220,
        0,
        ...
        0,
        7,
        '{"buildings":{"metal_mine":6,"crystal_mine":5},"technologies":{"logistics":3}}',
        NOW(),
        NOW()
    ),
    (
        'robotics_center',
        'Centre robotique',
        'Automatise les chantiers grâce à des drones spécialisés.',
        'support',
        1200,
        650,
        200,
        ...
        0,
        15,
        '{"buildings":{"workers_hub":5,"research_lab":4},"technologies":{"engineering_heavy":4}}',
        NOW(),
        NOW()
    ),
    (
        ...
        'Exploite des chambres de confinement pour fournir une énergie colossale.',
        'energy',
        2400,
        1600,
        900,
        ...
        750,
        0,
        '{"buildings":{"fusion_reactor":8,"research_lab":10},"technologies":{"reactor_antimatter":4,"superstructures":2}}',
        NOW(),
        NOW()
    )
...
INSERT INTO players (
    ...
    'admin@genesis.test',
    'Admin',
    '$2y$12$4Ir9LyckFCa6VjX22Op4EezPPZPdz2ohw8H1tS8yAO5zaRk.C0GpO',
    NOW(),
    NOW(),
    NOW()
)
...
INSERT INTO planets (
    ...
    hydrogen,
    prod_metal_per_hour,
    prod_crystal_per_hour,
    prod_hydrogen_per_hour,
    prod_energy_per_hour,
    energy,
    metal_capacity,
    crystal_capacity,
    hydrogen_capacity,
...
INSERT INTO player_technologies (
    player_id,
    technology_id,
    level,
    created_at,
...
WHERE NOT EXISTS (
    SELECT 1
    FROM fleets
    WHERE player_id = @admin_player_id
